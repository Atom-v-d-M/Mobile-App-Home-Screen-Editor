  ...
  switch (type) {
    case "carousel":
      return {
        id: createId(),
        type: "carousel",
        items: [{ id: createId(), kind: "image", url: "https://picsum.photos/seed/home-1/800/800", alt: "" }],
        aspect: "square",
        showPagination: true,
        loop: false,
      };
    ...
    sections: [
      {
        ...
        type: "carousel",
        items: [
          { id: createId(), kind: "image", url: "https://picsum.photos/seed/home-1/800/800", alt: "" },
          {
            id: createId(),
            kind: "video",
            url: SAMPLE_VIDEO_URL,
            alt: "",
            poster: "https://picsum.photos/seed/home-video/800/800",
          },
          { id: createId(), kind: "image", url: "https://picsum.photos/seed/home-3/800/800", alt: "" },
        ],
        aspect: "square",
        showPagination: true,
        loop: false,
